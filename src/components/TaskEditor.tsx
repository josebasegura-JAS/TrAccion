    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 p-4 backdrop-blur-[1px]">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2 border-t border-metro-border pt-3">
            <button
            ...
            <button
              className="ml-auto rounded-lg border border-metro-border bg-metro-surface px-3 py-2 text-sm font-semibold text-metro-muted hover:text-metro-text"
              onClick={onDone}
              type="button"
            >
              Cancelar
