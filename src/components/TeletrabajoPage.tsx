...
import {
  ...
  type PendingEncuestaImport,
} from '../features/teletrabajo/components/TeletrabajoEncuestaImportModal';
import { TeletrabajoHistoricoImportModal } from '../features/teletrabajo/components/TeletrabajoHistoricoImportModal';
import {
...
import {
  ...
  persistStoredPuestoAliases,
  readStoredPuestoAliases,
  suggestNextPeriodo,
  uniqueSorted,
} from '../features/teletrabajo/components/teletrabajoPageUtils';
...
export function TeletrabajoPage({
  ...
  return (
    ...
    >
      ...
      {isPeriodoModalOpen && (
        <TeletrabajoPeriodoModal
          copyFromPreviousPeriodo={copyFromPreviousPeriodo}
          newPeriodoName={newPeriodoName}
          onClose={() => setIsPeriodoModalOpen(false)}
          onCreatePeriodo={() => void handleCreatePeriodo()}
          periodoStatus={periodoStatus}
          periodos={periodos}
          setCopyFromPreviousPeriodo={setCopyFromPreviousPeriodo}
          setNewPeriodoName={setNewPeriodoName}
          setSourcePeriodo={setSourcePeriodo}
          sourcePeriodo={sourcePeriodo}
        />
      )}

      {pendingEncuestaImport && (
        <TeletrabajoEncuestaImportModal
          masterPuestos={masterPuestos}
          onClose={() => setPendingEncuestaImport(null)}
          onConfirm={() => void handleResolvePendingEncuestaImport()}
          pendingEncuestaImport={pendingEncuestaImport}
          setPendingEncuestaImport={setPendingEncuestaImport}
        />
      )}
      ...
      {pendingHistoricoImport && (
        <TeletrabajoHistoricoImportModal
          onCancel={handleCancelImportHistorico}
          onConfirm={() => void handleConfirmImportHistorico()}
