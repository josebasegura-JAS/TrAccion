...
export const AJUSTES_HELP_SECTIONS: ModuleHelpSection[] = [
  {
    ...
    body: 'Centraliza toda la configuración técnica de TrAcción: dónde vive la base de datos compartida, sus copias de respaldo, la carpeta de actualizaciones automáticas, las plantillas Word externas y las fases de Tareas.',
  },
  {
    title: 'Base de datos',
    items: [
      'Muestra la ruta activa de SQLite y su estado (correcto, aviso, error o bloqueado) para saber si TrAcción está trabajando contra la ubicación compartida esperada.',
  ...
  },
  {
    ...
    items: [
      'TrAcción guarda copias locales automáticas (base SQLite + un JSON de emergencia). El JSON solo debe usarse si la base SQLite no es recuperable; no sustituye a la copia SQLite.',
