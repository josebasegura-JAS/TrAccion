    ...
    <section className="rounded-3xl border border-metro-border bg-white p-5 shadow-card">
      <div className="mb-5">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-metro-muted">
          Configura rutas externas necesarias para generar documentos sin almacenar plantillas dentro
          de TrAccion.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-metro-border bg-[#FAFBFC] p-4">
        ...
        <label className="block text-xs font-semibold text-metro-muted">
          Ruta plantilla DOCX
          <input
            className="mt-1 w-full rounded-lg border border-metro-border bg-white px-3 py-2 text-sm font-medium text-metro-text outline-none focus:border-metro-red"
