  ...
  return <div className="space-y-4">
    ...
    {selectedUnion && <div className="grid gap-4 xl:grid-cols-[420px_minmax(0,1fr)]">
      <section className="rounded-2xl border border-metro-border bg-metro-surface p-4 shadow-card">
        ...
        <p className="mt-1 text-xs leading-5 text-metro-muted">Las tareas son opcionales. También se incorporarán los asuntos marcados y los pendientes de la última reunión; después podrás añadir tareas o puntos libres desde la reunión.</p>
        ...
        <button className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-metro-red px-3 py-2 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:opacity-50" onClick={() => void handleCreate()} type="button"><CalendarDays size={16}/>Crear reunión</button>
      </section>
