...
const sizeClassBySize: Record<ActionButtonSize, string> = {
  md: 'h-[38px] rounded-[10px] px-3.5 text-sm',
...
export function ActionButton({
  ...
  return (
    <button
      className={cx(
        'inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap border font-semibold leading-none transition duration-150 disabled:cursor-not-allowed disabled:opacity-50',
