...
export function SearchField({
  ...
  return (
    <div
      className={cx(
        'relative h-[38px] min-w-[14rem] flex-1 rounded-[10px] border border-metro-border bg-metro-surface/80 shadow-inner shadow-slate-950/10',
    ...
    >
      ...
      <input
        className={cx(
          'h-full w-full rounded-[10px] bg-transparent pl-9 pr-3 text-[13px] font-medium text-metro-text outline-none placeholder:text-metro-muted',
