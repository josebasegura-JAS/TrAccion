...
export const fieldLabelClass = 'mb-1 block text-[11px] font-semibold uppercase tracking-[0.10em] text-metro-muted';

export const fieldInputClass =
  'h-[38px] w-full rounded-[10px] border border-metro-border bg-metro-panel/80 px-3 text-[13px] normal-case text-metro-text outline-none transition focus:border-metro-red focus:bg-metro-surface required:border-red-400/45 required:bg-red-400/[0.07] disabled:cursor-not-allowed disabled:opacity-60';
...
export function Textarea({ className, ...props }: TextareaProps) {
  return (
    <textarea
      className={cx(
        'w-full rounded-[10px] border border-metro-border bg-metro-panel/80 px-3 py-2 text-[13px] normal-case text-metro-text outline-none transition focus:border-metro-red focus:bg-metro-surface required:border-red-400/45 required:bg-red-400/[0.07] disabled:cursor-not-allowed disabled:opacity-60',
        className,
      )}
      {...props}
    />
...
export function ReadonlyValue({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div
      className={cx(
        'flex min-h-[38px] items-center rounded-[10px] border border-metro-border bg-metro-panel/85 px-3 text-sm text-metro-text',
        className,
      )}
    >
      {children}
