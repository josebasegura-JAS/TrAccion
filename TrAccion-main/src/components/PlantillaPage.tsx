...
export function PlantillaPage() {
  ...
  return (
    <section className="space-y-3" id="plantilla">
      ...
      <div className="rounded-xl border border-metro-border/75 bg-metro-panel/45 p-2">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-metro-border/65 bg-metro-panel/35 px-3 py-1.5 text-[11px]">
      ...
      <div className="overflow-hidden rounded-xl border border-metro-border bg-metro-surface/70 shadow-sm shadow-slate-950/15">
