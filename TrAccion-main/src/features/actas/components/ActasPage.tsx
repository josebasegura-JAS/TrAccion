...
import { FilterSelect, SearchField, Toolbar } from '../../../components/ui/Toolbar';
    ...
    >
      <PageHeader
        ...
        actions={
          <Toolbar>
            <SearchField
              containerClassName="min-w-[320px]"
                onChange={(event) => setSearch(event.target.value)}
                placeholder="Buscar por título, estado, actualización, alegación o ruta..."
                value={search}
            />
            <FilterSelect containerClassName="w-[210px]" label="Estado" onChange={(event) => setStateFilter(event.target.value)} value={stateFilter}>
            ...
            <FilterSelect containerClassName="w-[150px]" label="Año" onChange={(event) => setYearFilter(event.target.value)} value={yearFilter}>
